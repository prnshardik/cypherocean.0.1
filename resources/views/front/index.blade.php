...
<html lang="en">
    <head>
        ...
        <!-- CSS Libraries -->
        <link href="{{ asset('front/vendor/bootstrap/4.4.1/css/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('front/vendor/font-awesome/5.10.0/css/all.min.css') }}" rel="stylesheet">
        ...
        <link href="{{ asset('front/vendor/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="51">
            ...
            <div class="container">
                ...
                <div class="row portfolio-container">
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item filter-1 wow fadeInUp" data-wow-delay="0.0s">
                        <div class="portfolio-wrap">
                            <div class="portfolio-img">
                                <img src="{{ asset('front/img/portfolio-1.jpg') }}" alt="Image">
                            </div>
                            <div class="portfolio-text">
                                <h3>eCommerce Website</h3>
                                <a class="btn" href="{{ asset('front/img/portfolio-1.jpg') }}" data-lightbox="portfolio">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item filter-2 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <div class="portfolio-img">
                                <img src="{{ asset('front/img/portfolio-2.jpg') }}" alt="Image">
                            </div>
                            <div class="portfolio-text">
                                <h3>Product Landing Page</h3>
                                <a class="btn" href="{{ asset('front/img/portfolio-2.jpg') }}" data-lightbox="portfolio">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item filter-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="portfolio-wrap">
                            <div class="portfolio-img">
                                <img src="{{ asset('front/img/portfolio-3.jpg') }}" alt="Image">
                            </div>
                            <div class="portfolio-text">
                                <h3>JavaScript quiz game</h3>
                                <a class="btn" href="{{ asset('front/img/portfolio-3.jpg') }}" data-lightbox="portfolio">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item filter-1 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="portfolio-wrap">
                            <div class="portfolio-img">
                                <img src="{{ asset('front/img/portfolio-4.jpg') }}" alt="Image">
                            </div>
                            <div class="portfolio-text">
                                <h3>JavaScript drawing</h3>
                                <a class="btn" href="{{ asset('front/img/portfolio-4.jpg') }}" data-lightbox="portfolio">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item filter-2 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="portfolio-wrap">
                            <div class="portfolio-img">
                                <img src="{{ asset('front/img/portfolio-5.jpg') }}" alt="Image">
                            </div>
                            <div class="portfolio-text">
                                <h3>Social Mobile Apps</h3>
                                <a class="btn" href="{{ asset('front/img/portfolio-5.jpg') }}" data-lightbox="portfolio">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item filter-3 wow fadeInUp" data-wow-delay="1s">
                        <div class="portfolio-wrap">
                            <div class="portfolio-img">
                                <img src="{{ asset('front/img/portfolio-6.jpg') }}" alt="Image">
                            </div>
                            <div class="portfolio-text">
                                <h3>Company Website</h3>
                                <a class="btn" href="{{ asset('front/img/portfolio-6.jpg') }}" data-lightbox="portfolio">+</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer wow fadeIn" data-wow-delay="0.3s">
            <div class="container-fluid">
                ...
                <div class="container copyright">
                    <p>&copy; <a href="#">Cypherocean</a>, All Right Reserved | </a></p>
                </div>
            </div>
        </div>
        <!-- Footer End -->
        ...
        <script src="{{ asset('front/vendor/bootstrap/4.4.1/js/bootstrap.bundle.min.js') }}"></script>
        <script src="{{ asset('front/vendor/easing/easing.min.js') }}"></script>
        <script src="{{ asset('front/vendor/wow/wow.min.js') }}"></script>
        <script src="{{ asset('front/vendor/waypoints/waypoints.min.js') }}"></script>
        ...
        <script src="{{ asset('front/vendor/lightbox/js/lightbox.min.js') }}"></script>
        
        <!-- Contact Javascript File -->
        <script src="{{ asset('front/js/jqBootstrapValidation.min.js') }}"></script>
